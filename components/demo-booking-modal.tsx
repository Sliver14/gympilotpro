          ...
          {step === 1 ? (
            <>
              <div className="mb-6">
                ...
                <div className="mt-3 inline-block px-2 py-1 bg-orange-500/10 border border-orange-500/20 text-[9px] font-black text-orange-500 uppercase tracking-widest italic">
                  ✓ Professional Setup & Launch Included
                </div>
              </div>
