      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-6">
        <div className="flex items-center gap-4">
          <Link href="/admin/dashboard" className="flex items-center gap-2 group">
            ...
            <span className="text-xl font-black uppercase italic tracking-tighter text-white">Klimarx<span className="text-[#daa857]">Space</span></span>
          </Link>
          
          {(title || description) && (
            <div className="hidden md:flex items-center gap-3 border-l border-white/10 pl-4">
              {title && <h1 className="text-[10px] font-black uppercase tracking-[0.3em] text-[#daa857]">{title}</h1>}
