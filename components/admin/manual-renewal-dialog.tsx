    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button 
          size="sm" 
          variant="outline" 
          className="h-10 px-6 border-red-500/20 bg-background hover:bg-red-500 hover:text-foreground text-red-500 font-black text-[10px] gap-2 rounded-xl transition-all"
        >
      ...
      <DialogContent className="bg-card border-border text-foreground rounded-[2.5rem] p-5 md:p-10 max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-8 py-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <div className="space-y-3">
              <Label htmlFor="startDate" className="text-[10px] font-black tracking-[0.2em] text-muted-foreground ml-1">Start Date *</Label>
              <Input
                id="startDate"
                type="date"
