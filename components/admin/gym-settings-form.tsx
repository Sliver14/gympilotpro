    ...
    <Card className="bg-card border-border shadow-2xl rounded-[2rem] overflow-hidden relative">
      <CardHeader className="bg-card/50 border-b border-border p-4 md:p-8">
        <div className="flex justify-between items-center">
          <div>
            <CardTitle className="text-2xl font-black uppercase italic tracking-tighter text-foreground">Gym Settings</CardTitle>
            <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest mt-1">Configure your gym's branding and integrations</p>
          </div>
      ...
      <CardContent className="p-4 md:p-8">
        <form onSubmit={handleSave}>
          <Tabs defaultValue="branding" className="w-full">
            <TabsList className="w-full justify-start h-auto p-1 bg-muted/50 border border-border rounded-2xl mb-8 flex-wrap">
              <TabsTrigger value="branding" className="rounded-xl px-6 py-3 font-black uppercase tracking-widest text-[10px] data-[state=active]:bg-card data-[state=active]:text-foreground data-[state=active]:shadow-sm">
                Branding & Display
              </TabsTrigger>
              <TabsTrigger value="payments" className="rounded-xl px-6 py-3 font-black uppercase tracking-widest text-[10px] data-[state=active]:bg-card data-[state=active]:text-foreground data-[state=active]:shadow-sm">
                Payment Integration
              </TabsTrigger>
            </TabsList>

            <TabsContent value="branding" className="space-y-10 outline-none">
              {/* Basic Information */}
              <div className="space-y-6">
                <div>
                  <h3 className="text-sm font-black uppercase italic tracking-widest text-foreground">Basic Information</h3>
                  <p className="text-xs text-muted-foreground font-bold uppercase tracking-widest mb-6">Customize your gym's textual identity.</p>
                </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground font-bold uppercase tracking-widest mb-6">Upload your gym's visual identity assets.</p>
                </div>
            ...
            <TabsContent value="payments" className="space-y-10 outline-none">
              <div className="space-y-6">
                <div>
                  <h3 className="text-sm font-black uppercase italic tracking-widest text-foreground">Payment Integration (Paystack)</h3>
                  <p className="text-xs text-muted-foreground font-bold uppercase tracking-widest mb-6">Connect your Paystack account to receive automated payments.</p>
                </div>

                <div className="bg-orange-500/10 border border-orange-500/20 p-4 md:p-6 rounded-2xl space-y-4 mb-6">
                  <p className="text-xs font-black uppercase tracking-widest text-orange-500">Important Setup Notice</p>
                  <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-widest leading-relaxed">
                    These keys are required for automated subscription renewals. Please copy the webhook URLs below into your Paystack Dashboard (Settings &gt; API Keys & Webhooks) to ensure payments are instantly synced.
                  </p>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground font-bold uppercase tracking-widest mb-6">Provide your gym's bank details for manual member renewals and signups.</p>
                </div>
            ...
            <div className="mt-10 pt-6 border-t border-border flex justify-end">
              <Button type="submit" disabled={saving} className="h-14 px-10 bg-[#daa857] hover:bg-[#cdb48b] text-black font-black uppercase tracking-widest rounded-xl shadow-lg hover:shadow-xl transition-all w-full md:w-auto">
                {saving ? <Loader2 className="animate-spin mr-2" /> : 'Save All Settings'}
              </Button>
            </div>
          </Tabs>
        </form>
